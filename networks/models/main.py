...
flags.DEFINE_float("sinkhorn_lambda", 30., "Entropy regularization for Sinkhorn algorithm [30]")
flags.DEFINE_integer("n_up", 1, "Number of discriminator updates per generator update [1]")
flags.DEFINE_string("prior_dist", "normal", "Distribution for samples generated from prior [normal]")
...
flags.DEFINE_string("solver", "ADAM", "Solver to use in optimization [ADAM]")
